...
class Model(models.Model):
    ...
    accuracy = models.JSONField(default=list,null=True,blank=True)
    val_accuracy = models.JSONField(default=list,null=True,blank=True)
    loss = models.JSONField(default=list,null=True,blank=True)
    val_loss = models.JSONField(default=list,null=True,blank=True)
