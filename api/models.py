...
class Model(models.Model):
    ...
    accuracy = models.JSONField(default=list,null=True)
    val_accuracy = models.JSONField(default=list,null=True)
    loss = models.JSONField(default=list,null=True)
    val_loss = models.JSONField(default=list,null=True)
